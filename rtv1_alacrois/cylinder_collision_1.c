...
/*   Updated: 2018/04/02 20:37:58 by alacrois         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "main.h"

static t_bool		bc_init(t_cylinder *c, t_plane *pl1, t_plane *pl2)
{
	if (c->infinite == true)
		return (false);
	pl1->vector = c->vector;
...
static t_bool		base_collision(t_ray ray, t_cylinder *c, t_rpoint *bc)
{
	t_rpoint		bcol1;
	t_rpoint		bcol2;
	t_plane			pl1;
...
static t_bool		between_bases(t_ray ray, t_cylinder *c, t_dpoint *s)
{
	t_rpoint		p1;
	t_rpoint		p2;
	t_rpoint		ccenter;
