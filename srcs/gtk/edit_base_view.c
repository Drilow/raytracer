...
/*   Updated: 2019/02/06 15:23:39 by cpays            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				end_cone_view(t_cone *c)
{
	...
	g_global.r.gtk_mgr.ui.add_view.angle_spin =
		gtk_spin_button_new(adj_angle, 1, 4);
	gtk_grid_attach(GTK_GRID(g_global.r.gtk_mgr.ui.add_view.grid),
...
void				edit_cone_view(t_cone *c)
{
	...
	GTK_STATE_FLAG_CHECKED | GTK_STATE_FLAG_INSENSITIVE, true);
	g_global.r.gtk_mgr.ui.add_view.vector_img =
		gtk_image_new_from_file("uiconfig/vector.png");
	gtk_grid_attach(GTK_GRID(g_global.r.gtk_mgr.ui.add_view.grid),
	...
	g_global.r.gtk_mgr.ui.add_view.inf_img =
		gtk_image_new_from_file("uiconfig/infinite.png");
	gtk_grid_attach(GTK_GRID(g_global.r.gtk_mgr.ui.add_view.grid),
	...
	gtk_switch_set_state(GTK_SWITCH(g_global.r.gtk_mgr.ui.add_view.infinite),
		c->infinite);
	g_global.r.gtk_mgr.ui.add_view.angle_img =
		gtk_image_new_from_file("uiconfig/angle.png");
	gtk_grid_attach(GTK_GRID(g_global.r.gtk_mgr.ui.add_view.grid),
...
void				edit_cylinder_view(t_cylinder *c)
{
	...
	GTK_STATE_FLAG_CHECKED | GTK_STATE_FLAG_INSENSITIVE, true);
	g_global.r.gtk_mgr.ui.add_view.scale_img =
		gtk_image_new_from_file("uiconfig/ruler.png");
	gtk_grid_attach(GTK_GRID(g_global.r.gtk_mgr.ui.add_view.grid),
	...
	g_global.r.gtk_mgr.ui.add_view.scale_spin =
		gtk_spin_button_new(adj_scale, 1, 4);
	gtk_grid_attach(GTK_GRID(g_global.r.gtk_mgr.ui.add_view.grid),
