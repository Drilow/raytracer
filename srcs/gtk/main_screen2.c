...
/*   Updated: 2019/01/23 10:08:54 by mabessir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				select_cb(void)
{
	...
	& GTK_STATE_FLAG_CHECKED))
	{
		gtk_widget_set_state_flags(GTKMGR.ui.main_view.select_button,
		...
		gtk_widget_unset_state_flags(GTKMGR.ui.main_view.select_button,
		GTK_STATE_FLAG_CHECKED);
}

void				handle_main_view_3(void)
{
	gtk_widget_set_tooltip_text(GTKMGR.ui.main_view.export_button,
	"export to png format");
	g_signal_connect(G_OBJECT(GTKMGR.ui.main_view.export_button),
	"clicked", G_CALLBACK(export_view), NULL);
	gtk_container_add(GTK_CONTAINER(GTKMGR.ui.main_view.buttonbox),
...
{
	gtk_button_set_image(GTK_BUTTON(GTKMGR.ui.main_view.add_button),
	GTKMGR.ui.main_view.add_img);
	gtk_container_add(GTK_CONTAINER(GTKMGR.ui.main_view.buttonbox),
	GTKMGR.ui.main_view.add_button);
	GTKMGR.ui.main_view.filters_button = gtk_button_new();
	gtk_widget_set_tooltip_text(GTKMGR.ui.main_view.filters_button, "filters");
	g_signal_connect(G_OBJECT(GTKMGR.ui.main_view.filters_button), "clicked",
	G_CALLBACK(filter_win), NULL);
	gtk_button_set_image(GTK_BUTTON(GTKMGR.ui.main_view.filters_button),
	GTKMGR.ui.main_view.filters_img);
	gtk_container_add(GTK_CONTAINER(GTKMGR.ui.main_view.buttonbox),
	GTKMGR.ui.main_view.filters_button);
	GTKMGR.ui.main_view.select_button = gtk_button_new();
	gtk_widget_set_tooltip_text(GTKMGR.ui.main_view.select_button,
	"select object");
	g_signal_connect(G_OBJECT(GTKMGR.ui.main_view.select_button),
	"clicked", G_CALLBACK(select_cb), NULL);
	gtk_button_set_image(GTK_BUTTON(GTKMGR.ui.main_view.select_button),
	GTKMGR.ui.main_view.select_img);
	gtk_container_add(GTK_CONTAINER(GTKMGR.ui.main_view.buttonbox),
	GTKMGR.ui.main_view.select_button);
	GTKMGR.ui.main_view.export_button = gtk_button_new();
	gtk_button_set_image(GTK_BUTTON(GTKMGR.ui.main_view.export_button),
